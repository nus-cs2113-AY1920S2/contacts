...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            case "list":
                ...
                break;
            case "clear":
                list = new String[MAXIMUM_CAPACITY][3];
                count = 0;
    ...
    private static void displayWelcomeMessage() {
        System.out.println("|| ===================================================");
        System.out.println("|| ===================================================");
        System.out.println("|| Contacts - Version 1.1");
        System.out.println("|| Welcome to Contacts! A program where you can add your favourite people!");
        System.out.println("|| ===================================================");
    }
